...
export default function GroupList() {
	...
	const items = [
		...
		{id: 2, name: 'Short Group 2', urlProfil: '/images/group2.jpg', role: 'myGroup'},
		{id: 3, name: 'Group 3', urlProfil: '/images/group2.jpg', role: 'myGroup'},
		{id: 4, name: 'Group 4', urlProfil: '/images/group1.jpg', role: 'myGroup'},
	]
